...
public class Main {
    public static String nearestPalindromic(String n) {
        ...
        for (long i : new long[] {-1, 0, 1}) {
            ...
            String candidate;
            if (length % 2 == 0) candidate = newPrefix + new StringBuilder(newPrefix).reverse().toString();
            else candidate = newPrefix + new StringBuilder(newPrefix.substring(0, newPrefix.length() - 1)).reverse().toString();
